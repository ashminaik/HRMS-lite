const ConfirmModal = ({ 
  ...
  const icons = {
    warning: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-[#F5D867]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    success: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-[#9AAB63]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
